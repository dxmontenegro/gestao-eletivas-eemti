...
// ----------------------------------------------------------------------
// URL FINAL E CORRETA (Confirmada pelo usuário: AKfycbwBIai5AvIrteYrmPlfD_EpTTJi00TWRR8pzzPch-J-45UePzKqIFXESUtZxH4EYncH)
// ----------------------------------------------------------------------
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Tenta carregar os dados dinâmicos logo no início para preencher os selects
    loadDynamicData(); 
});
    ...
    try {
        ...
        try {
            result = await response.json();
             ...
             // Tratamento para caso o GAS retorne um HTML de erro em vez de JSON
            if (response.ok) {
                // Sucesso no HTTP (200), mas falha ao ler a resposta JSON
...
async function loadDynamicDataForMap() {
    // Reutiliza a função principal de carregamento de dados e apenas atualiza o select do mapa
    await loadDynamicData();
}

// --- 5. Lógica da Aba "Mapa de Eletivas" (Mantida) ---
